...
void siever_side_config::declare_usage(cxx_param_list & pl)
{
    ...
    param_list_decl_usage(pl, "mfb_pre_ecm", "post-sieve small batch bounds per side, in bits");
    ...
    std::vector<std::string> const & mandatory)
{
    ...
    DISPATCH_PARAMETER(unsigned int, mfb_pre_ecm, UINT_MAX, ARGS_PER_SIDE_DEFAULT_COPY_PREVIOUS);
