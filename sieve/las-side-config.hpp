...
struct siever_side_config {
    ...
    unsigned int mfb;     /* bound for residuals is 2^mfb after sieving and batching*/
    unsigned int mfbb;    /* bound for residuals is 2^mfbb after sieving and before batching*/
